...
module Solid
  class Variable
    ...
    # tag or Solid auto-escaping is globally enabled, this will run the
    ...
    #
    # @param [Solid::Context] context The variable's rendering context
    ...
    def render(context)
      ...
      if is_global && is_local == false
        ...
        variable = Autoescape::TemplateVariable.from_solid_variable(self)
